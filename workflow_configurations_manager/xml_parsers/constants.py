...
Meanings:
    CO_SIM_ARRANGEMENT_CHECK_BEFORE_CREATION: Check whether the directory already exists before creating it
    CO_SIM_ARRANGEMENT_DIR_CREATION: A directory will be created by using the specified path
"""
CO_SIM_ARRANGEMENT_CHECK_BEFORE_CREATION = 'CO_SIM_ARRANGEMENT_CHECK_BEFORE_CREATION'
CO_SIM_ARRANGEMENT_DIR_CREATION = 'CO_SIM_ARRANGEMENT_DIR_CREATION'
CO_SIM_ARRANGEMENT_DUTIES_TUPLE = (
    CO_SIM_ARRANGEMENT_DIR_CREATION, CO_SIM_ARRANGEMENT_CHECK_BEFORE_CREATION
)
...
CO_SIM_ENABLE_MONITORING = 'CO_SIM_ENABLE_MONITORING'
CO_SIM_ENABLE_REST_APP_SERVER = 'CO_SIM_ENABLE_REST_APP_SERVER'
CO_SIM_PARAMETERS_TUPLE = (
    CO_SIM_FUNCTIONAL_PARAMETERS,
    CO_SIM_SCIENTIFIC_PARAMETERS,
    CO_SIM_ENABLE_MONITORING,
    CO_SIM_ENABLE_REST_APP_SERVER
)
