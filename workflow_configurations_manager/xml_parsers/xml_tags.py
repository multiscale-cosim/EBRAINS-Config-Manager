...
CO_SIM_XML_PLAN_ACTION_GOAL = 'action_goal'
CO_SIM_XML_PLAN_ACTION_REALM = 'action_realm'
CO_SIM_XML_PLAN_ACTION_LABEL = 'action_label'
...
CO_SIM_XML_ACTION_SCIENTIFIC_PARAMETERS = 'scientific_parameters'
